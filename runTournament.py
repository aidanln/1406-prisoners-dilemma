...
from prison import NicePlayer as NicePlayer
from prison import MeanPlayer as MeanPlayer
from prison import RandomPlayer as RandomPlayer
import random
import math
import time
import sys
...
from AnotherSampleAgent import SampleAgent as Agent2
...
def runTournament(nPlayers):
    ...
    getPlayers(...) function
    """
    NROUNDS = 100 # Actual value will be determined randomly
